...
foreach (config('tenancy.central_domains') as $domain) {
    Route::domain($domain)->group(function () {
        ...
        Route::get('/', function () {
            // App portal has no central login - redirect to a message or tenant selection
            return Inertia::render('auth/tenant-login-required');
        })->name('home');
        ...
        Route::get('/auth/public-portal', function (Request $request) {
            ...
            if (! $expires || $expires < time()) {
                ...
                return redirect('/')->with('error', 'Authentication link has expired. Please try again.');
            }
            ...
            if (! hash_equals($expectedHash, $hash)) {
                ...
                return redirect('/')->with('error', 'Invalid authentication link. Please try again.');
            }
