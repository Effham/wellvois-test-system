...
interface PractitionerConsentsProps {
    practitioner: {
        id: number;
        first_name: string;
        last_name: string;
...
export default function PractitionerConsents({ practitioner, pendingConsents, acceptedConsents, flash }: PractitionerConsentsProps) {
    ...
    const handleAcceptAll = () => {
        ...
        router.post(
            route('practitioner.consents.accept-all'),
            {
    ...
    const handleRevoke = (versionId: number) => {
        ...
        router.post(
            route('practitioner.consents.revoke', { consentVersion: versionId }),
            {
                practitioner_id: practitioner.id,
            },
            {
        ...
        <AppLayout>
            ...
            <div className="p-6 md:p-6 page-content-mobile">
                <PageHeader
                    ...
                    description="Review and manage your consent preferences"
                />
                            ...
                            <div className="pt-4 border-t space-y-4">
                                ...
                                <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        >
                                            I have read and accept all {pendingConsents.length} required consent{pendingConsents.length !== 1 ? 's' : ''}
                                        </Label>
                                ...
                                >
                                    ...
                                    {processing ? 'Processing...' : `Accept All & Continue`}
                                </Button>
                            </div>
                        </CardContent>
                    </Card>
                ...
                {acceptedConsents.length > 0 && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                You have accepted the following consents. Optional consents may be revoked at any time.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
