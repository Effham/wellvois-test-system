...
<body>
    <div class="error-container">
        ...
        <div class="inertia-notice">
            <strong>Navigation Error:</strong> An error occurred while loading this page. The application will reload automatically.
        </div>
        
        <p class="error-message">
            Oops! Something went wrong while processing your request. We're sorry for the inconvenience.
        </p>
        ...
        <script>
            // Auto-reload after 5 seconds for Inertia requests
            setTimeout(function() {
