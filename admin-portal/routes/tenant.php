...
// Admin portal is central-only - no tenant routes
// Tenant routes disabled for admin-portal
/*
Route::middleware([
    'web',
...
// Website Settings API Routes (for admin) - DISABLED: admin-portal is central-only
/*
...
*/ // End of disabled tenant routes for admin-portal (central-only)
