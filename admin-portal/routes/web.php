    ...
    Route::domain($domain)->group(function () {
        ...
        Route::get('/auth/public-portal', function (Request $request) {
            ...
            if (! $expires || $expires < time()) {
                ...
                return redirect()->route('admin.login')->with('error', 'Authentication link has expired. Please try again.');
            }
            ...
            if (! $user) {
                ...
                return redirect()->route('admin.login')->with('error', 'User not found. Please try again.');
            }
            ...
            if (! hash_equals($expectedHash, $hash)) {
                ...
                return redirect()->route('admin.login')->with('error', 'Invalid authentication link. Please try again.');
            }
