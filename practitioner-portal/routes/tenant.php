...
// Practitioner portal is central-only - no tenant routes
// Tenant routes disabled for practitioner-portal
/*
Route::middleware([
    'web',
...
// Website Settings API Routes (for admin) - DISABLED: practitioner-portal is central-only
/*
...
*/ // End of disabled tenant routes for practitioner-portal (central-only)
